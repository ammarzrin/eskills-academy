...
<html lang="en">
  <head>
    ...
    <link
      ...
      rel="stylesheet"
    />
    <title>Training Provider Home Page</title>
  </head>
  <body>
    ...
    <main>
      <div
        id="main-container"
        class="always-centered"
      >
        <aside>
          <h1>Training Provider</h1>
          <p>
          ...
          <br />
          <section class="use-case-buttons">
            <a href="#"><button class="bb">View Profile</button></a>
            <a href="#"><button class="bb">Edit Profile</button></a>
            <a href="#"><button class="bb">Create New Course</button></a>
          </section>
        </aside>
